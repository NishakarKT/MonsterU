  ...
  return (
    <Fragment>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Paper sx={{ position: "relative", p: 2, height: "calc(100vh - 300px)", minHeight: "350px", maxHeight: "600px" }}>
            ...
            <CardMedia sx={{ width: `30px`, position: "absolute", bottom: "25%", right: "10%", objectFit: "contain", zIndex: 1, filter: "brightness(0)" }} component="img" src={"/images/trainer1.png"} alt="" />
            <CardMedia sx={{ width: `75px`, position: "absolute", bottom: "28%", right: "40%", objectFit: "contain", zIndex: 0, display: {xs: "none", sm: "inline"} }} component="img" src={"/images/trainer1.gif"} alt="" />
            <CardMedia sx={{ width: `75px`, position: "absolute", bottom: "28%", right: "30%", objectFit: "contain", zIndex: 0, display: {xs: "none", sm: "inline"} }} component="img" src={"/images/trainer2.gif"} alt="" />
            {myPkmn && myPkmn.data && myPkmn.stats ? (
              <Stack spacing={1} sx={{ position: "absolute", bottom: "15%", left: "30%", zIndex: 5 }}>
                ...
                <CardMedia ref={myPkmnRef} sx={{ height: `100px`, objectFit: "contain", opacity: Number(myPkmn.stats.HP) === 0 ? "0.5" : "1" }} component="img" src={getSprite(myPkmn.data.id, "b")} alt="" />
                {/* <CardMedia ref={myPkmnRef} sx={{ height: `${Math.max(Math.min((Number(myPkmn.data.profile.height.split(" ")[0]) / 2) * 100, 150), 75)}px`, objectFit: "contain", opacity: Number(myPkmn.stats.HP) === 0 ? "0.5" : "1" }} component="img" src={getSprite(myPkmn.data.id, "b")} alt="" /> */}
              </Stack>
            ) : null}
            {foePkmn && foePkmn.data && foePkmn.stats ? (
              <Stack spacing={1} sx={{ position: "absolute", bottom: "20%", right: "20%", zIndex: 4 }}>
                ...
                <CardMedia ref={foePkmnRef} sx={{ height: `75px`, objectFit: "contain", opacity: Number(foePkmn.stats.HP) === 0 ? "0.5" : "1" }} component="img" src={getSprite(foePkmn.data.id)} alt="" />
                {/* <CardMedia ref={foePkmnRef} sx={{ width: `75px`, transform: `scale(${Math.min(2, Number(foePkmn.data.profile.height.split(" ")[0]))})`, objectFit: "contain", opacity: Number(foePkmn.stats.HP) === 0 ? "0.5" : "1" }} component="img" src={getSprite(foePkmn.data.id)} alt="" /> */}
              </Stack>
            ) : null}
            {foePkmns
              .filter((pkmn) => pkmn.data.id !== foePkmn.data.id)
              .map((foePkmn, index) => (
                <CardMedia sx={{ position: "absolute", bottom: "28%", right: `${15 * ((index + 1) / foePkmns.length)}%`, zIndex: 0, width: `50px`, objectFit: "contain", opacity: Number(foePkmn.stats.HP) === 0 ? "0.5" : "1" }} component="img" src={getSprite(foePkmn.data.id)} alt="" />
                // <CardMedia sx={{ position: "absolute", bottom: "28%", right: `${10 * ((index + 1) / foePkmns.length)}%`, zIndex: 0, width: `${Math.max(Math.min((Number(foePkmn.data.profile.height.split(" ")[0]) / 5) * 100, 100), 25)}px`, objectFit: "contain", opacity: Number(foePkmn.stats.HP) === 0 ? "0.5" : "1" }} component="img" src={getSprite(foePkmn.data.id)} alt="" />
              ))}
